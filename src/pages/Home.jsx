      ...
      <div className="container">
        ...
        <section className="hero">
          ...
          <p className="hero-description">
            ...
            Learn with simple explanations, real-world applications, practical
            examples, coding exercises, and challenge questions.
          </p>

          <p className="hero-description">
            This platform is designed to help students understand not only
            <strong> how to code</strong>, but also
            <strong> where</strong>,<strong> why</strong>, and
