...
Java-வில் Classes மூலம் Hybrid Inheritance ஆதரிக்கப்படாது. ஏனெனில் அது குழப்பங்களை (Ambiguity) ஏற்படுத்தும். ஆனால் ஒரு Class-ஐ Extend செய்து, பல Interfaces-ஐ Implement செய்வதன் மூலம் Hybrid Inheritance-ஐ Java-வில் செயல்படுத்த முடியும்.`,
  ...
  englishDefinition:
    "Exception Handling is a mechanism in Java used to handle runtime errors so that the normal flow of a program can continue without crashing.",

  tamilDefinition:
    "Exception Handling என்பது Program இயங்கும் போது (Runtime) ஏற்படும் பிழைகளை (Errors) கையாள பயன்படும் Java Mechanism ஆகும். இதன் மூலம் Program திடீரென நிற்காமல் (Crash ஆகாமல்) தொடர்ந்து இயங்க முடியும்.",

  realWorldUsage:
    "Developers use Exception Handling to prevent programs from crashing due to unexpected situations such as invalid user input, division by zero, missing files, or network failures.",

  realWorldUsageTamil:
    "தவறான User Input, பூஜ்ஜியத்தால் வகுத்தல் (Division by Zero), File கிடைக்காதது அல்லது Network பிரச்சினைகள் போன்ற எதிர்பாராத சூழ்நிலைகளால் Program Crash ஆகாமல் இருக்க Developers Exception Handling-ஐ பயன்படுத்துகின்றனர்.",
  ...
  syntaxExplanationEnglish: [
    ...
    "Exception is the type of exception being handled.",
  ...
  syntaxExplanationTamil: [
    ...
    "Exception என்பது கையாளப்படும் Exception-ன் வகையாகும்.",
  ...
  programExplanationEnglish: [
    "Line 5: The try block starts.",
    "Line 7: Dividing a number by zero causes an ArithmeticException.",
    "Line 13: The catch block catches the exception.",
    "Line 15: Displays an appropriate error message.",
    "Line 19: The program continues executing after the exception is handled."
  ],

  programExplanationTamil: [
    "வரி 5: try Block தொடங்குகிறது.",
    "வரி 7: ஒரு எண்ணை பூஜ்ஜியத்தால் வகுப்பதால் ArithmeticException ஏற்படுகிறது.",
    "வரி 13: catch Block அந்த Exception-ஐ கையாளுகிறது.",
    "வரி 15: பொருத்தமான Error Message Console-ல் காட்டப்படுகிறது.",
